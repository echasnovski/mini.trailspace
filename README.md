...
<!-- [![GitHub tag](https://badgen.net/github/tag/echasnovski/mini.trailspace)](https://github.com/echasnovski/mini.trailspace/tags/) -->
<!-- [![Current version](https://badgen.net/badge/Current%20version/development/cyan)](https://github.com/echasnovski/mini.trailspace/blob/main/CHANGELOG.md) -->
<!-- badges: end -->

**Work with trailing whitespace**

See more details in [help file](doc/mini-trailspace.txt).
...
<table>
    ...
    <tbody>
        ...
        <!-- <tr> -->
        <!--     <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>use 'echasnovski/mini.trailspace'</code></td> -->
        <!-- </tr> -->
        <!-- <tr> -->
        <!--     <td>Stable</td> <td><code>use { 'echasnovski/mini.trailspace', branch = 'stable' }</code></td> -->
        <!-- </tr> -->
    </tbody>
</table>
